...
{
    "location": "orders/elements.html#Hecke.coordinates-Tuple{NfAbsOrdElem{AnticNumberField,nf_elem}}",
    "page": "Elements",
...

{
    ...
    "title": "Hecke.ideal",
    "category": "method",
    "text": "ideal(O::NfOrd, x::NfOrdElem) -> NfAbsOrdIdl\n\nCreates the principal ideal (x) of mathcal O.\n\n\n\n"
},
